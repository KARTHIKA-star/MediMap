...
public class MedicineItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.medicine_item); // Replace with your actual XML file name
        ...
        btnSyrups.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MedicineItemActivity.this, "Syrups clicked!", Toast.LENGTH_SHORT).show();
                 Intent intent = new Intent(MedicineItemActivity.this, SyrupsActivity.class);
        ...
        items_images1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MedicineItemActivity.this, items_names1.getText() + " selected", Toast.LENGTH_SHORT).show();
            }
        });
